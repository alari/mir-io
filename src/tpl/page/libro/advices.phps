<?php class tpl_page_libro_advices extends tpl_page implements i_tpl_page_rightcol, i_locale, i_tpl_page_submenu {
...
public function __construct($filename="", $params="")
 ...
 <?
 	...
 	$anonces = ws_libro_pub::several_query("SELECT SQL_CALC_FOUND_ROWS p.* FROM mr_publications p LEFT JOIN mr_pub_advices a ON a.pub_id=p.id WHERE a.time>unix_timestamp()-86400*7 ORDER BY RAND()");

 	$pager = "";

 	if(0&&$page*$this->perpage+count($anonces) < $count || $page)
 	{
